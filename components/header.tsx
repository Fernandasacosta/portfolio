    ...
    <header id="home" className=" py-8 xl:py-5 text-white">
      <div className="px-0 container mx-auto flex justify-between items-center pt-5">
       ...
       <div className="flex flex-row items-center gap-2">
        ...
        {/* desktop nav  */}
        <div className= {`${syne.className} bg-[#233831] rounded-3xl mt-14 py-4 px-8 fixed top-0 left-1/2 transform -translate-x-1/2 hidden xl:flex items-center gap-10`}>
          <Nav />
        </div>
        ...
        <button
          type="button"
          className="px-6 py-3.5 text-base font-syne text-white bg-[#233831] hover:bg-[#0E332A] focus:ring-4 focus:outline-none rounded-3xl text-center hidden xl:block">
            Hire me
        </button>
        </Link>
