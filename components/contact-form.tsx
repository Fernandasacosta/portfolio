    ...
    <section className="py-16 px-6 md:py-32 flex items-center justify-center bg-red-900">
      <div className="w-full max-w-[420px] mx-auto bg-white">
        ...
        >
          <input
            placeholder="Nome"
            className="w-full h-14 bg-orange-400 rounded-lg placeholder:text-gray-400 text-gray-50 p-4 foclus:outiline-none focus:ring-2 ring-emerald-50"
            {...register('name')}
          />
          <input
            type="email"
          ...
          <input
            ...
            className="resize-none w-full h-[138px] bg-orange-400 rounded-lg placeholder:text-gray-400 text-gray-50 p-4 foclus:outiline-none focus:ring-2 ring-emerald-50"
            maxLength={500}
            {...register('message')}
          />
